import type { Demand, DemandStatus, ExternalInteraction, ExternalInteractionResult, ExternalInteractionType, NewDemandOutcome, PositioningAttachment } from './demand.entity'
